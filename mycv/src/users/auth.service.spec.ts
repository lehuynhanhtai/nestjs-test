...
describe('AuthService', () => {
  ...
  it('returns a user if correct password is provied', async () => {
    await service.signup('test@test.com', 'mypasword');
    const user = await service.signin('test@test.com', 'mypasword');
